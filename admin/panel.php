...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="images/sonriendo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Shiba Inu store</span>
    </a>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <?php echo ($modulo=="estadisticas"||$modulo=="")?" active ":" "; ?>">
              ...
              <li class="nav-item">
                ...
                <?php echo ($modulo=="usuarios" || $modulo=="crearUsuario" || $modulo=="editarUsuario")?" active ":" "; ?>">
              ...
              <li class="nav-item">
                ...
                <?php echo ($modulo=="productos")?" active ":" "; ?>">
  ...
  <footer class="main-footer">
    <strong>Creado en Nov/2022 - Actualizado Nov/2022</strong>
...
<script>
  $(document).ready(function () {
    $(".borrar").click(function (e) { 
      e.preventDefault();
      var res=confirm("Realmente quieres borrar ese usuario?");
      if(res==true){
