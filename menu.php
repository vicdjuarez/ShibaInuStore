...
<nav class="navbar navbar-expand navbar-dark">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <a class="navbar brand nav-link">
                            <img src="img/logo.png" width="20px" alt="logo"  class="d-inline-block align-text-top img-fluid">
                            &nbsp;&nbsp; Shiba Inu Store
                        </a>
                        </li>
                        <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <li class="nav-item d-none d-sm-inline-block">
                            <a href="index.php?modulo=aboutus" class="nav-link">Conoce Mas</a>
                        </li>
                    </ul>
                    ...
                    <form class="form-inline ml-3" action="index.php">
                        <div class="input-group input-group-sm">
                            ...
                            <input class="form-control form-control-navbar bg-gray" type="search" placeholder="Buscar" aria-label="Search" name="nombre" value="<?php try{echo $_REQUEST['nombre'] ?? '';} catch(Exception $e){} ?>">
